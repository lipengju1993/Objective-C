...
#数据表名
TABLENAME="CodeConfusionOC"

#数据库名
SYMBOL_DB_FILE="CodeConfusionOC.db"

#要被替换的方法列表文件
STRING_SYMBOL_FILE="$PROJECT_DIR/CodeConfusion/func.list"

#被替换后的宏定义在此文件里
HEAD_FILE="$PROJECT_DIR/$PROJECT_NAME/CodeConfusionOC.h"
...
echo '#ifndef CodeConfusionOC_h

#define CodeConfusionOC_h' >> $HEAD_FILE
