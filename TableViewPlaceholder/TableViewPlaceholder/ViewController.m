...
#import "YJTableViewPlaceholder.h"
static const CGFloat CYLDuration = 1.0;
#define CYLRandomData [NSString stringWithFormat:@"随机数据---%d", arc4random_uniform(1000000)]

@interface ViewController ()<YJTableViewPlaceholderDelegate, WeChatStylePlaceHolderDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"YJTableViewPlaceHolder";
